    ...
    <ModalContainer open={open}>
      ...
      <ModalBody>
        <div className="flex flex-col items-center gap-1">
          <label htmlFor="questions">Cantidad de preguntas</label>
          <div className="flex items-center gap-2">
            ...
            <input ref={refQuestions} defaultValue={totalQuestions ?? ""} disabled type="number" id="questions" min={1} max={totalQuestions} className="border border-sage/20 rounded-md py-2 text-center" />
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="w-full max-w-lg">
            ...
            <div className="flex justify-between mt-2 text-xs tracking-tighter">
              <button className="text-slate-800 italic -translate-x-4" onClick={() => setTime(0)}>Sin límite</button>
